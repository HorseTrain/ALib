...
namespace ArmLIB.Emulator.Aarch64
{
    public unsafe class Process 
    {
        ...
        public Process(IGuestMemoryModel GuestMemory, IHostMemoryManager HostMemory)
        {
        ...
        TranslatedFunction TranslateFunction(ulong Address, bool Multple, Dictionary<string, int> ContextOffsets = null, bool OptimizeSSA = false)
        {
            ...
            CompiledFunction nativeFunction = X86Assembler.CompileOperations<CompiledFunction>(CurrentIR, HostMemory, Address,out ulong FunctionAddress);

            return new TranslatedFunction(HostMemory, FunctionAddress, nativeFunction);
        }
